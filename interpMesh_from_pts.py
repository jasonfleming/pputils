...
#
# Revised: May 27, 2016
# Changed the name of the script from interp_from_pts.py to 
# interpMesh_from_pts.py.
#
...
# Example:
#
# python interpMesh_from_pts.py -p points.csv -m mesh.grd -o mesh_interp.grd -n 10
# where:
...
if len(sys.argv) != 9 :
	...
	print('Usage:')
	print('python interpMesh_from_pts.py -p points.csv -m mesh.grd -o mesh_interp.grd -n 10')
	sys.exit()
