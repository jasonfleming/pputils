...
#
# Modified: Nov 6, 2016
# Changed the name of the script from interp.py to interpMesh.py
#
...
# Example:
#
# python interpMesh.py -t tin.grd -m mesh.grd -o mesh_interp.grd
# where:
# -t tin surface
...
if len(sys.argv) != 7 :
	...
	print('Usage:')
	print('python interpMesh.py -t tin.grd -m mesh.grd -o mesh_interp.grd')
	sys.exit()
